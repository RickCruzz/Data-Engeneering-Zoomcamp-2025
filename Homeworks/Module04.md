...
``` Solution: "C" - Its Looking for the variable and if doesnt find any value its gonna use the second one.  ```
...
``` Solution: "D" It will check the var for the values for days_back, inside of it will check the env_var that should have for dev. Anything else will be 30 days  ```
...
``` Solution: "E" It will run Staging and its children.```
